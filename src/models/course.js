...
export default {
    ...
    effects: {
        ...
        *fetchCurrentCourse({ payload }, { call, put }) {
            let data = yield call(courseServices.fetchCurrentCourse, {id : payload.id});
        ...
        *editCourse({ payload }, { call, put }) {
            let data = yield call(courseServices.editCourse, {currentEditCourse : payload.currentEditCourse});
            yield put({ type: 'handleCourseModal', payload: data });
